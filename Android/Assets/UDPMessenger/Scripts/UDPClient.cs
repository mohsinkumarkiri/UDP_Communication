...
{		
	...
	public void Awake ()
	{
        portSend = PlayerPrefs.GetInt("portSend");
        ipSend = PlayerPrefs.GetString("ipSend");
	...
	void Update ()
	{
		...
		if (received != ""){
            ...
            messageRecieved.text = "UDPClient: message received " + received;
